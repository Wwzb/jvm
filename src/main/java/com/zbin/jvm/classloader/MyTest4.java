...
/**
 * 对于数组实例来说,其类型是由JVM运行期动态生成的,表示为[Lcom.zbin.jvm.classloader.MyParent4;这种形式
 *
 * 动态生成的类型,其父类型是Object
 *
...
public class MyTest4 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(myParent4s.getClass());//[Lcom.zbin.jvm.classloader.MyParent4;
    System.out.println(myParent4s.getClass().getClassLoader());

    System.out.println("========");

    MyParent4[][] myParent4s1 = new MyParent4[1][1];
    System.out.println(myParent4s1.getClass());//class [[Lcom.zbin.jvm.classloader.MyParent4;
